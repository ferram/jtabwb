...
public class ModalFormulaParseException extends Exception {
	...
	public ModalFormulaParseException(String message, Throwable cause) {
		super(message, cause);
	}

	public ModalFormulaParseException(String message) {
		super(message);
	}

	public ModalFormulaParseException(Throwable cause) {
		super(cause);
	}
