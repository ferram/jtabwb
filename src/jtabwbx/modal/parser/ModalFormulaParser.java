 ...
 * <li><code>box</code>: prefix, unary</li>
 * <li><code>dia</code> (diamond): prefix, unary</li>
 * </ul>
 * </li>
 * </ul>
 * 
...
public class ModalFormulaParser {
  ...
  public ParseTree parse(String str) throws ModalFormulaParseException {
    try {
      ModalFormulaLexerSignalingErrors lexer =
          new ModalFormulaLexerSignalingErrors(new ANTLRInputStream(str));
